...
class Settings(BaseModel):
    ...
    nel_agent_uri: str = Field(default_factory=lambda: get_config_value("NEL_AGENT_URI", "nel_agent_uri", "http://lblod.data.gift/id/components/named-entity-linking/v1.0.0"))
